...
export function Login() {
      ...
      <div className={styles.pageContainer}>
        <div className={styles.roleSelectionContainer}>
          ...
          <div className={styles.roleGrid}>
            <Button appearance="subtle" className={styles.roleCard} onClick={() => setRole("asesora")}>
            ...
            <Button appearance="subtle" className={styles.roleCard} onClick={() => setRole("gerente")}>
  ...
  if (role === "asesora" && !selectedAdvisor) {
    return (
      <div className={styles.pageContainer}>
          ...
          <Card className={styles.loginCard} style={{ maxWidth: "600px" }}>
            ...
            <div className={styles.advisorGrid}>
              {advisorsList.map(advisor => (
                <Button key={advisor.id} appearance="subtle" className={styles.advisorCard} onClick={() => setSelectedAdvisor(advisor)}>
